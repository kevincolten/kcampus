...
@student6 = Student.create!( :idn => "7894563",
                         ...
                         :dob => "1987-1-24",
                         :phone => "1234567890",
                         :email => "reid@hello.com",
                         :client_id => @client1.id )
                        

@student7 = Student.create!( :idn => "9638522",
                         :fname => "Justin",
                         :lname => "Carter",
                         :dob => "1986-12-30",
                         :phone => "1234567890",
                         :email => "just@hello.com",
                         :client_id => @client1.id )
